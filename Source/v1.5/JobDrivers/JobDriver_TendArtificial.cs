...
{
    // Create an alternate version of the TendPatient job to use the appropriate artificial stats instead of medical stats.
    public class JobDriver_TendArtificial : JobDriver_TendPatient
    {
        // Override the Toils to use artificial tend stats instead of medical ones.
