...
namespace ArtificialBeings
{
    ...
    {
        // Artificial units check against different hediffs than organics do for temperature hediff concerns. We need to ensure they notify their lord group leader if any pawn is endangered with their unique hediffs.
        ...
        public class ActivateOn_Patch
        {
            ...
            public static bool Prefix(ref bool __result, Lord lord, TriggerSignal signal)
            {
                ...
                for (int i = lord.ownedPawns.Count - 1; i >= 0; i--)
                {
                    ...
                    HashSet<HediffDef> targetHediffDefs = ABF_Utils.GetTemperatureHediffDefs(pawn.def);
