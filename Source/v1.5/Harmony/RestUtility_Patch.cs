...
namespace ArtificialBeings
{
    ...
    {
        // RestUtility.TimetablePreventsLayDown has a non-null checked rest need that will throw errors for artificial units resting when assigned to work in the time table.
